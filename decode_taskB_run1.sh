...
# HPI
python long_training.py --gpus 1 --strategy deepspeed_stage_2 --precision bf16 --max_input_length 10000 --max_output_length 2500 --is_split "HISTORY OF PRESENT ILLNESS" --pretrained_model google/long-t5-tglobal-base --is_test True --checkpoint ./output/lightning_logs/version_0/checkpoints/best.ckpt --test_file $input_csv  
...
# ASSESSMENT
python long_training.py --gpus 1 --strategy deepspeed_stage_2 --precision bf16 --max_input_length 10000 --max_output_length 2500 --is_split "ASSESSMENT AND PLAN" --pretrained_model google/long-t5-tglobal-base --is_test True --checkpoint ./output/lightning_logs/version_3/checkpoints/best.ckpt --test_file $input_csv
